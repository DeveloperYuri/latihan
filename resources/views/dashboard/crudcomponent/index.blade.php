...
@section('content')
    <main id="main" class="main">
        ...
        <a href="{{ route('productcomponent.create') }}" class="btn btn-primary mb-3">New</a>
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">CRUD Component Table</h5>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($productcomponent as $index => $p)
                                        <tr>
                                            {{-- <th></th> --}}
                                            <td class="text-center">{{ $productcomponent->firstItem() + $index  }}</td>
                                            ...
                                            <td class="text-center">
                                                <form action="{{ route('productcomponent.destroy', $p->id) }}" method="POST">
                                                    <a href="{{ route('productcomponent.show', $p->slug) }}"
                                                        class="btn btn-sm btn-primary">Show</a>
                                                    <a href="{{ route('productcomponent.edit', $p->slug) }}"
